...
export default function Content() {
    return (
        <div className='w-full h-80 flex items-center justify-center border-b-blue border-b-4 relative'>
            ...
            <div className='sm:w-9/12 md:w-1/2  items-center absolute text-center text-black-F3 sm:text-xl lg:text-3xl'>
                ...
                <div className='flex flex-row mt-4 h-8 justify-center'>
                    ...
                    <button className='flex items-center  bg-light-blue hover:bg-blue active:bg-dark-blue text-white p-2  text-sm w-24'>
                            SEARCH
